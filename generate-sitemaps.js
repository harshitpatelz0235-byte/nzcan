...
languages.forEach(lang => {
  ...
  routes.forEach((route) => {
    xml += '  <url>\\n';
    xml += '    <loc>' + baseUrl + '/${lang}' + route + '</loc>\\n';
  ...
  fs.writeFileSync(path.join(__dirname, 'src', 'app', 'sitemap-' + lang + '.xml', 'route.js'), content);
});

console.log('Sitemap route handlers generated successfully.');
