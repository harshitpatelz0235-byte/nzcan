...
export async function generateMetadata({ params }) {
  ...
  const dict = (await getDictionary(lang)).jsonViewer;

  return {
    title: dict.title,
    description: dict.subtitle,
    alternates: {
      canonical: `https://errordocs.com/${lang}/json-viewer`,
      languages: {
        'en': 'https://errordocs.com/en/json-viewer',
        'hi': 'https://errordocs.com/hi/json-viewer',
        'pt': 'https://errordocs.com/pt/json-viewer',
        'es': 'https://errordocs.com/es/json-viewer',
        'de': 'https://errordocs.com/de/json-viewer',
        'id': 'https://errordocs.com/id/json-viewer',
      }
    }
  };
}

export default async function JsonViewerPage({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonViewer;
  const seoContent = (await getSeoDictionary(lang)).jsonViewer;
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": `https://errordocs.com/${lang}/json-viewer`
          }
        ]
      },
      {
