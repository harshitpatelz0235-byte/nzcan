...
import JsonToTsClient from "../../../components/JsonToTsClient";
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'en': 'https://errordocs.com/en/json-to-ts',
        'hi': 'https://errordocs.com/hi/json-to-ts',
        'pt': 'https://errordocs.com/pt/json-to-ts',
        'es': 'https://errordocs.com/es/json-to-ts',
        'de': 'https://errordocs.com/de/json-to-ts',
        'id': 'https://errordocs.com/id/json-to-ts',
      }
    }
  };
}

export default async function JsonToTsPage({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonToTs;
  const seoContent = (await getSeoDictionary(lang)).jsonToTs;
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": `https://errordocs.com/${lang}/json-to-ts`
          }
        ]
      },
      {
