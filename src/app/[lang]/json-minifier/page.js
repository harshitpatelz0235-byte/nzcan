...
import JsonMinifierClient from "../../../components/JsonMinifierClient";
import ToolSeoContent from "../../../components/ToolSeoContent";

export async function generateMetadata({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonMinifier;

  return {
    title: dict.title,
    description: dict.subtitle,
    alternates: {
      canonical: `https://errordocs.com/${lang}/json-minifier`,
      languages: {
        'en': 'https://errordocs.com/en/json-minifier',
        'hi': 'https://errordocs.com/hi/json-minifier',
        'pt': 'https://errordocs.com/pt/json-minifier',
        'es': 'https://errordocs.com/es/json-minifier',
        'de': 'https://errordocs.com/de/json-minifier',
        'id': 'https://errordocs.com/id/json-minifier',
      }
    }
  };
}

export default async function JsonMinifierPage({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonMinifier;
  const seoContent = (await getSeoDictionary(lang)).jsonMinifier;
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": `https://errordocs.com/${lang}/json-minifier`
          }
        ]
      },
      {
