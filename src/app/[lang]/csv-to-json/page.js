...
import CsvToJsonClient from "../../../components/CsvToJsonClient";
import ToolSeoContent from "../../../components/ToolSeoContent";

export async function generateMetadata({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).csvToJson;

  return {
    title: dict.title,
    description: dict.subtitle,
    alternates: {
      canonical: `https://errordocs.com/${lang}/csv-to-json`,
      languages: {
        'en': 'https://errordocs.com/en/csv-to-json',
        'hi': 'https://errordocs.com/hi/csv-to-json',
        'pt': 'https://errordocs.com/pt/csv-to-json',
        'es': 'https://errordocs.com/es/csv-to-json',
        'de': 'https://errordocs.com/de/csv-to-json',
        'id': 'https://errordocs.com/id/csv-to-json',
      }
    }
  };
}

export default async function CsvToJsonPage({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).csvToJson;
  const seoContent = (await getSeoDictionary(lang)).csvToJson;
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": `https://errordocs.com/${lang}/csv-to-json`
          }
        ]
      },
      {
