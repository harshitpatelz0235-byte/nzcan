...
import JsonToCsvClient from "../../../components/JsonToCsvClient";
import ToolSeoContent from "../../../components/ToolSeoContent";

export async function generateMetadata({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonToCsv;

  return {
    title: dict.title,
    description: dict.subtitle,
    alternates: {
      canonical: `https://errordocs.com/${lang}/json-to-csv`,
      languages: {
        'en': 'https://errordocs.com/en/json-to-csv',
        'hi': 'https://errordocs.com/hi/json-to-csv',
        'pt': 'https://errordocs.com/pt/json-to-csv',
        'es': 'https://errordocs.com/es/json-to-csv',
        'de': 'https://errordocs.com/de/json-to-csv',
        'id': 'https://errordocs.com/id/json-to-csv',
      }
    }
  };
}

export default async function JsonToCsvPage({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonToCsv;
  const seoContent = (await getSeoDictionary(lang)).jsonToCsv;
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": `https://errordocs.com/${lang}/json-to-csv`
          }
        ]
      },
      {
