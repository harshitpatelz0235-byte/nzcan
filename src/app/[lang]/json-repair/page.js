...
import JsonRepairClient from "../../../components/JsonRepairClient";
import ToolSeoContent from "../../../components/ToolSeoContent";

export async function generateMetadata({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonRepair;

  return {
    title: dict.title,
    description: dict.subtitle,
    alternates: {
      canonical: `https://errordocs.com/${lang}/json-repair`,
      languages: {
        'en': 'https://errordocs.com/en/json-repair',
        'hi': 'https://errordocs.com/hi/json-repair',
        'pt': 'https://errordocs.com/pt/json-repair',
        'es': 'https://errordocs.com/es/json-repair',
        'de': 'https://errordocs.com/de/json-repair',
        'id': 'https://errordocs.com/id/json-repair',
      }
    }
  };
}

export default async function JsonRepairPage({ params }) {
  const { lang } = await params;
  const dict = (await getDictionary(lang)).jsonRepair;
  const seoContent = (await getSeoDictionary(lang)).jsonRepair;
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "item": `https://errordocs.com/${lang}/json-repair`
          }
        ]
      },
      {
